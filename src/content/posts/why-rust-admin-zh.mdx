...
但直到最近，我才真正尝试用 Rust 构建一套完整的全栈后台管理系统，并将其命名为 [`rustzen-admin`](https://github.com/rustzen/rustzen-admin)。
...
为了整理开发过程中学到的知识，我将其总结为一个模板项目 [`rustzen-admin`](https://github.com/rustzen/rustzen-admin)，目标是：
...
- 🔗 GitHub 项目地址：[rustzen-admin](https://github.com/rustzen/rustzen-admin)
- 🏠 我的博客（中英文）：[rustzen.dev](https://rustzen.dev)
