...
Recently, I started building a Rust-based full-stack project called [`rustzen-admin`](https://github.com/rustzen/rustzen-admin).
...
- Project Repo: [`rustzen-admin`](https://github.com/rustzen/rustzen-admin)
- More posts on my blog: [rustzen.dev](https://rustzen.dev)
